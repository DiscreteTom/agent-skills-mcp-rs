...
### Added
- Support multiple skill folders via repeated `--skill-folder` flags or comma-separated values (e.g. `SKILL_FOLDER=~/skills,~/more-skills`)
...
[unreleased]: https://github.com/DiscreteTom/agent-skills-mcp-rs/compare/v0.3.0...HEAD
[0.3.0]: https://github.com/DiscreteTom/agent-skills-mcp-rs/compare/v0.2.0...v0.3.0
